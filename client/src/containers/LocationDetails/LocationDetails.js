  ...
  render() {
    return ( 
      <div className="locationDetails_container">
        <div className="locationDetails_container_1">
        ...
        <div className="locationDetails_container_5">

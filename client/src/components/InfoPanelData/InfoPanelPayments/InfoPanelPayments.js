...
const InfoPanelPayments = (props) => {
  ...
  return (
    <div className="InfoPanel_charging_container">
      ...
      <div className="infoPanel_section_data InfoPanelPayments_container">
        ...
        <div className="content_neutral">
          {" "}
          {stateAbbr} State Tax: {vehicleOrder.state_tax_rate}%
        </div>
        {props.whichComponent === "vehicles" ? (
          <div className="content_vehicle">
            <h4>Registration</h4>
            ...
            <div className="app_source_footer">
              <a
                href={vehicleOrder.registration.source}
                target="_blank"
        ...
        {props.whichComponent === "solar" ? (
          <div className="content_solar">
            ...
            <div>
              Notice: There may be additional upgrades required, e.g., electric
              main panel, or hidden conduit.
            </div>
            <div>
              A Federal Investment Tax Credit (ITC) is generally available to
              anyone who purchases solar panels. Powerwall paired with solar,
              including existing solar PV systems, is a qualified expenditure.
              To be eligible for tax credits, you must have tax liability at
              least equal to the credit. Tesla does not guarantee incentive
              amounts or your eligibility. Please consult with a tax advisor.
            </div>
          </div>
        ) : (
          ""
...
export default InfoPanelPayments;

...
import "./VehicleUserEntryFinancing.css";

const VehicleUserEntryFinancing = ({
  activeFormVals,
  handleFormChange,
  usStateVehicleOrder,
  error,
  ...
  return (
    <div className="VehicleUserEntryFinancing_container">
...
export default VehicleUserEntryFinancing;

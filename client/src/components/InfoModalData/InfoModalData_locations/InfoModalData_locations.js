              ...
              {allShowrooms.sSortedArr[0] ? (
                <div className="infoPanel_showroom1">
                  ...
                  {allShowrooms.sObj[allShowrooms.sSortedArr[0]][2].map(
                    (line) => (
                      <p className="infoPanel_showroom1_address">{line}</p>
                    )
                  )}
                  <p>
                    <span>Store: </span>
         ...
         <div className="infoModalData_showroom_container">
           {allServiceCenters.scSortedArr[0] ? (
             <div className="infoPanel_showroom1">
               ...
               {allServiceCenters.scObj[allServiceCenters.scSortedArr[0]][2].map(
                 (line) => (
                   <p className="infoPanel_showroom1_address">{line}</p>
                 )
               )}
               <p>
                 <span>Store: </span>
                 <span className="infoPanel_showroom1_phone">
                   {allServiceCenters.scObj[allServiceCenters.scSortedArr[0]][4]}
                 </span>
               </p>
               <p className="infoPanel_showroom1_openTimes">
                 For Opening times and more:{" "}
                 <a
                   href={allServiceCenters.scObj[allServiceCenters.scSortedArr[0]][1]}
                   target="_blank"
                 >
                   link
                 </a>
           ...
           {allServiceCenters.scSortedArr[1] ? (
             ...
             {allServiceCenters.scObj[allServiceCenters.scSortedArr[1]][2].map(
               (line) => (
                 <p className="infoPanel_showroom1_address">{line}</p>
               )
             )}
             <p>
               <span>Store: </span>
               <span className="infoPanel_showroom1_phone">
                 {allServiceCenters.scObj[allServiceCenters.scSortedArr[1]][4]}
               </span>
             </p>
             <p className="infoPanel_showroom1_openTimes">
               For Opening times and more:{" "}
               <a
                 href={allServiceCenters.scObj[allServiceCenters.scSortedArr[1]][1]}
                 target="_blank"
               >
                 link
               </a>
        ...
        {allChargingLocations ? (
         ...
         <div className="infoModalData_showroom_container">
           {allChargingLocations.clSortedArr[0] ? (
             <div className="infoPanel_showroom1">
               <h4 className="infoPanel_showroom1_name">
                 {allChargingLocations.clObj[allChargingLocations.clSortedArr[0]][0]}
               </h4>
               {allChargingLocations.clObj[allChargingLocations.clSortedArr[0]][2].map(
                 (line) => (
                   <p className="infoPanel_showroom1_address">{line}</p>
                 )
               )} 
               <p className="infoPanel_showroom1_openTimes">
                 For Opening times and more:{" "}
                 <a
                   href={allChargingLocations.clObj[allChargingLocations.clSortedArr[0]][1]}
                   target="_blank"
                 >
                   link
                 </a>
           ...
           {allChargingLocations.clSortedArr[1] ? (
             <div className="infoPanel_showroom1">
             <h4 className="infoPanel_showroom1_name">
               {allChargingLocations.clObj[allChargingLocations.clSortedArr[1]][0]}
             </h4>
             {allChargingLocations.clObj[allChargingLocations.clSortedArr[1]][2].map(
               (line) => (
                 <p className="infoPanel_showroom1_address">{line}</p>
               )
             )} 
             <p className="infoPanel_showroom1_openTimes">
               For Opening times and more:{" "}
               <a
                 href={allChargingLocations.clObj[allChargingLocations.clSortedArr[1]][1]}
                 target="_blank"
               >
                 link
               </a>

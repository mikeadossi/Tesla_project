...
import "./InfoModalDataLocations.css";
import { useSelector } from "react-redux";

const InfoModalDataLocations = () => {
  const allLoc = useSelector((state) => state.navReducer.getLocations);

  return (
    <div className="InfoModalDataLocations_container">
...
export default InfoModalDataLocations;
